...
namespace NerdStore.Vendas.Domain
{
    ...
    public class VoucherAplicavelValidation : AbstractValidator<Voucher>
    {
        ...
        public static string ValorDescontoErrroMsg=> "O valor do desconto precisa ser superior a 0.";
        public static string PercentualDescontoErroMsg=> "O valor da porcentagem de desconto precisa ser superir a 0.";
        ...
        public VoucherAplicavelValidation()
        {
            ...
            When(f=>f.TipoDescontoVoucher == TipoDescontoVoucher.Valor,()=>
            {
                RuleFor(f=>f.ValorDesconto)
                    .NotNull()
                    .WithMessage(ValorDescontoErrroMsg)
                    .GreaterThan(0)
                    .WithMessage(ValorDescontoErrroMsg);
            });
