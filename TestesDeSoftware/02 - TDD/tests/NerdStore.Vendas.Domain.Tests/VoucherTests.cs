...
namespace NerdStore.Vendas.Domain.Tests
{
    public class VoucherTests
    {
        ...
        public void Voucher_ValidarVoucherTipoValor_DeveEstarInvalido()
        {
            ...
            Assert.Contains(VoucherAplicavelValidation.ValorDescontoErrroMsg, result.Errors.Select(c => c.ErrorMessage));
        ...
        [Fact(DisplayName = "Validar Voucher Tipo Valor inválido")]
        [Trait("Categoria", "Vendas - Voucher")]
        public void Voucher_ValidarVoucherTipoPorcentagel_DeveEstarInvalido()
        {
            // Arrange
